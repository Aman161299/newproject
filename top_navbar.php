                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="become-instructor.html">BECOME A INSTRUCTOR</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li class="has-children">
                                            ...
                                            <ul class="sub-menu">
                                                <li class="has-children"><a href="#">SHOP LAYOUT</a>
                                                    <ul class="sub-menu">
                                                        <li><a href="shop_left_sidebar.php">SHOP LEFT SIDEBAR</a></li>
                                                        <li><a href="shop-right-sidebar.html">SHOP RIGHR SIDEBAR</a>
                                                        </li>
